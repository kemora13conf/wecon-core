...
class BaseClass {
    ...
    logError(error, tracedSatckInfo) {
        console.error(chalk_1.default.red.bold("\n╔══════════════════════════════════════════════════════════╗"), chalk_1.default.red.bold("\n║") +
            chalk_1.default.white.bold("  Route Configuration Error                            ") +
            chalk_1.default.red.bold("   ║"), chalk_1.default.red.bold("\n╚══════════════════════════════════════════════════════════╝\n"));
        console.error(chalk_1.default.red.bold("✖ Error:"), chalk_1.default.white(error.title));
        console.error(chalk_1.default.gray("\n  Details:"), chalk_1.default.white(error.details));
        console.error(chalk_1.default.gray("\n  Location:"), chalk_1.default.cyan(`${tracedSatckInfo.file}:${tracedSatckInfo.line}:${tracedSatckInfo.column}`));
        console.error(chalk_1.default.yellow.bold("\n  💡 How to fix:"));
        console.error(chalk_1.default.yellow(`  ${error.fix.replace(/\n/g, "\n  ")}`));
