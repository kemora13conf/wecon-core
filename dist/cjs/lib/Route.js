...
class Route extends BaseClass_1.default {
    constructor(r) {
    ...
    validateRoute() {
         ...
         */
        if (!this.method) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:MISSING_METHOD");
        }
        /**
         * 2. Validate the path property
         */
        if (!this.path) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:MISSING_PATH");
        }
        /**
         * 3. Validate the rai property
         */
        if (!this.rai) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:MISSING_RAI");
        }
        if (typeof this.rai !== "string") {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:INVALID_RAI_TYPE");
        }
        if (Route.registeredRAIs.has(this.rai)) {
            throw new errors_1.default.ConfigError(`ROUTE_CONFIG:DUPLICATE_RAI`);
        }
        /**
         * 4. Validate the roles property
         */
        if (!this.roles) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:MISSING_ROLES");
        }
        /**
         * 5. Validate the middlewares property type
         */
        if (!Array.isArray(this.middlewares)) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:INVALID_MIDDLEWARES_TYPE");
        }
        /**
         * 6. Validate that middlewares array is not empty
         */
        if (this.middlewares.length === 0) {
            throw new errors_1.default.ConfigError("ROUTE_CONFIG:EMPTY_MIDDLEWARES");
        }
    }
    handleConfigError(err, errInfo) {
        const POSSIBLE_ERRORS = {
            ...
            "ROUTE_CONFIG:MISSING_RAI": {
                ...
                details: "The Route instance requires a unique 'rai' (Route Access Identifier) to be defined",
            ...
            "ROUTE_CONFIG:INVALID_RAI_TYPE": {
                ...
                details: "The 'rai' property must be a string, but received: " +
                    typeof this.rai,
            ...
            "ROUTE_CONFIG:INVALID_MIDDLEWARES_TYPE": {
                ...
                details: "The 'middlewares' property must be an array, but received: " +
            ...
            "ROUTE_CONFIG:EMPTY_MIDDLEWARES": {
                ...
                details: "The Route instance requires at least one middleware function to handle the request",
