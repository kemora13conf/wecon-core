import type { PostmanDescription, PostmanAuth, PostmanVariableList, PostmanEventList, PostmanProtocolProfileBehavior, PostmanForRoutesConfig } from "../types/postman.types";
/**
 ...
 * ```
 */
declare class PostmanForRoutes {
