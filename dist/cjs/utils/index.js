...
exports.pathToRaiMatcher = pathToRaiMatcher;
 ...
 */
function pathToRaiMatcher(config) {
    /**
    ...
    for (const r of rais) {
        if (r.method.trim() === method.trim()) {
            ...
            const test = (0, path_to_regexp_1.match)(formattedRaiPath); // Create a matcher for the RAI path
